# Contributing to Debug Dungeon

Debug Dungeon is part of the Fox & Hen public tool set. Contributions should keep the project useful, inspectable, forkable, and safe to demonstrate in public.

## Good First Contributions

- Add or improve a synthetic sample scenario that demonstrates: A playable website QA dungeon game with bug enemies, rooms, switches, scoring, and exportable run reports.
